...
public class StockManagementServiceImpl extends BaseOpenmrsService implements StockManagementService {
    ...
    public StockOperation saveStockOperation(StockOperationDTO dto) {
        ...
        Location atLocation = StringUtils.isBlank(dto.getAtLocationUuid())
                ? null
                : Context.getLocationService().getLocationByUuid(dto.getAtLocationUuid());
        if (atLocation == null && stockOperation.getDestination() != null) {
            atLocation = stockOperation.getDestination().getLocation();
        }
        if (atLocation == null && stockOperation.getSource() != null) {
            atLocation = stockOperation.getSource().getLocation();
        }
        stockOperation.setAtLocation(atLocation);
